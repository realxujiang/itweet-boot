package cn.itweet.modules.front.twts;
...
public class TwtsController {
    ...
    @GetMapping(value = "/")
    public String home(@RequestParam(value = "page", defaultValue = "0") Integer page,Model model) {
